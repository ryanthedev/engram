...
const file_engram_proto_rawDesc = "" +
	...
	"\x04hits\x18\x01 \x03(\v2\x0e.engram.v1.HitR\x04hits2\x86\x01\n" +
	"\x06Engram\x12=\n" +
	"\x06Ingest\x12\x18.engram.v1.IngestRequest\x1a\x19.engram.v1.IngestResponse\x12=\n" +
	"\x06Search\x12\x18.engram.v1.SearchRequest\x1a\x19.engram.v1.SearchResponseB+Z)github.com/ryanthedev/engram/api/engrampbb\x06proto3"
...
var file_engram_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_engram_proto_depIdxs = []int32{
	5, // 0: engram.v1.IngestRequest.occurred_at:type_name -> google.protobuf.Timestamp
	...
	1, // 4: engram.v1.Engram.Ingest:output_type -> engram.v1.IngestResponse
	4, // 5: engram.v1.Engram.Search:output_type -> engram.v1.SearchResponse
